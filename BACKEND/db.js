...
const config = {
  ...
  stmtCacheSize: 30,
  events: false, // Disable events to avoid memory leaks
  externalAuth: false, // Use internal authentication by default
  homogeneous: true, // Use homogeneous connections for better performance
};
